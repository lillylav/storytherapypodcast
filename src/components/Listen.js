...
function Listen() {
    return (
        <section className="box columns is-centered m-3 mt-5 periwinkle-background">
            <div className="column has-text-centered">
                <img src={ thumbnail } />
                <h2 className="title is-2 has-text-centered dark-font">Listen & Subscribe</h2>
                <div className="columns is-centered">
                    <div className="column has-text-centered">
                        <a href="https://open.spotify.com/show/2jIln2x3n06beogkLmELKt" target="_blank" className="dark-font link">
                            <h3 className="subtitle is-3 has-text-centered dark-font">Spotify</h3>
                    ...
                    <div className="column has-text-centered">
                        <a href="https://podcasts.apple.com/us/podcast/story-therapy-podcast/id1641952821" target="_blank" className="dark-font link">
                            <h3 className="subtitle is-3 has-text-centered dark-font">Apple Podcasts</h3>
                    ...
                    <div className="column has-text-centered">
                        <a href="https://www.google.com/podcasts?feed=aHR0cHM6Ly9hbmNob3IuZm0vcy82NWQzYTI3NC9wb2RjYXN0L3Jzcw==" target="_blank" className="dark-font link">
                            <h3 className="subtitle is-3 has-text-centered dark-font">Google Podcasts</h3>
